        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              {/* Badge flotante - Próximo Curso (simplificado) */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="bg-[#FBEA24] text-[#233a63] px-4 py-2 rounded-xl shadow-lg">
                  <span className="text-xs font-bold uppercase tracking-wide">Próximo Curso</span>
                  <p className="text-sm font-bold mt-0.5">{featuredProgram.startDate}</p>
                </div>
              </motion.div>

              {/* Badge flotante - Inscripciones Abiertas (simplificado) */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="bg-[#316eb5] text-white px-4 py-2 rounded-xl shadow-lg">
                  <span className="text-xs font-bold">Inscripciones Abiertas</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
